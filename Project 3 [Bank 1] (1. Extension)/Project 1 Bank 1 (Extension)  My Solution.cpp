// Project 1 Bank 1 (Extension)  My Solution.cpp : Diese Datei enthält die Funktion "main". Hier beginnt und endet die Ausführung des Programms.
...
// New Extension: Transactions
bool DepositBalanceToClient(string AccountNumber, vector <sClient>& vClients, double Amount)
{
	char Answer = 'n';
...
void ShowDepositScreen()
{
	...
	cin >> Amount;
	DepositBalanceToClient(AccountNumber, vClients, Amount);
}
void ShowWithdrawScreen()
{
	...
	{
		cout << "\nAmount Exceeds the balnce you can withdraw up to : " << Client.AccountBalance << endl;
		cout << "Please enter another amount? ";
		cin >> Amount;
	}
	DepositBalanceToClient(AccountNumber, vClients, Amount * -1); // deposit an negative value >> Client.AccountBalance - Amount
